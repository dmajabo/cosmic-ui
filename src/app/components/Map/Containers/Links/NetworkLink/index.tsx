...
const NetworkLink: React.FC<IProps> = ({ id, type, sourceId, targetId, targetType, sourceType, x1, y1, x2, y2 }) => {
  ...
  return (
    ...
    >
      ...
      {vpsAttachedPos && <Attachment id={`vpcattached${id}`} iconClass="attachmentVpcIcon" icon={vpcAttachedIcon} label="VPC ATTACHMENT" pos={vpsAttachedPos} />}
    </g>
  );
};
