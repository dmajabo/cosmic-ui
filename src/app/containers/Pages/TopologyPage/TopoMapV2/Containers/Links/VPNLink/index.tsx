...
import { IDeviceNode, ITGWNode, ITopoLink, ITopoNode, ITopoSitesNode } from 'lib/hooks/Topology/models';
import { INetworkVpnLinkState } from 'lib/api/ApiModels/Topology/apiModels';
import { useTopologyV2DataContext } from 'lib/hooks/Topology/useTopologyDataContext';
import TransitionContainer from '../../TransitionContainer';

interface IProps {
  dataItem: ITopoLink<ITopoSitesNode, IDeviceNode, ITopoNode<any, ITGWNode>, ITGWNode, INetworkVpnLinkState>;
}
