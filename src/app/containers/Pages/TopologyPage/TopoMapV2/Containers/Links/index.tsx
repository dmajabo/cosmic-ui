    ...
    <g>
      {Object.keys(props.links).map((key, i) => {
        if (props.links[key].type === TopoLinkTypes.NetworkNetworkLink) {
          return <NetworkNetworkLink key={props.links[key].extId} dataItem={props.links[key]} visible={props.links[key].visible} />;
        }
        if (props.links[key].type === TopoLinkTypes.VPNLink) {
          return <VPNLink key={props.links[key].extId} dataItem={props.links[key]} visible={props.links[key].visible} />;
        }
