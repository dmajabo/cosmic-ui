  ...
  return (
    <>
      ...
      <StyledMap
        ...
        width="100%"
        height="100%"
        viewBox={`0 0 ${sizes && sizes.width ? sizes.width : STANDART_DISPLAY_RESOLUTION_V2.width} ${sizes && sizes.height ? sizes.height - 70 : STANDART_DISPLAY_RESOLUTION_V2.height}`}
        fill="none"
