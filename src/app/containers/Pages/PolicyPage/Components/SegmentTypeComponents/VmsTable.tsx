...
interface Props {
  ...
  selectedIds: string[];
  onSelectChange: (type: SegmentSegmentType, item: INetworkVM) => void;
  onSelectAll: (type: SegmentSegmentType, item: INetworkVM[]) => void;
...
const VmsTable: React.FC<Props> = (props: Props) => {
  ...
  const onRowClick = (params: GridRowParams) => {
    props.onSelectChange(SegmentSegmentType.APPLICATION, params.row as INetworkVM);
  };

  const onColumnHeaderClick = (params: GridColumnHeaderParams) => {
    if (params.field === '__check__') {
      props.onSelectAll(SegmentSegmentType.APPLICATION, props.data);
    }
  };
