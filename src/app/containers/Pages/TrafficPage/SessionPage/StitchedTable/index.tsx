  ...
  const [aggregatedColumnTabs, setColumnTabs] = React.useState<ITabsColumnFilterData[]>([
    {
      ...
      items: [
        ...
        { ...StitchedColumns.destSegmentId },
        { ...StitchedColumns.destSegmentName },
        { ...StitchedColumns.protocol },
        { ...StitchedColumns.deviceVendor, body: (d: INetworkVendorSessionSummary) => cellTemplates.cellSessionVendorTemplate(d.deviceVendor) },
      ],
    },
    {
      tab: 'Inside',
      ...
      items: [
        ...
        {
          ...StitchedLogGridColumns.deviceVendor,
          hide: false,
          body: (d: INetworkSession) => cellTemplates.cellSessionVendorTemplate(d.deviceVendor),
        },
